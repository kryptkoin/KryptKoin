...
int64 nChainStartTime = 1401186150;
...
const string strMessageMagic = "KryptKoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
     ...
     if(nHeight == 1)
     {
       nSubsidy = 17000000 * COIN;	// 17 million coins, that all pow coins
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in KryptKoin
    bool fStrictPayToScriptHash = true; // Always active in KryptKoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "KryptKoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "KryptKoin";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1401186160;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2367888;
        ...
        assert(block.hashMerkleRoot == uint256("0xfad35b4422d48f529d7e48ea186b645661b60ba39a472a1edc86833679894f2c"));
